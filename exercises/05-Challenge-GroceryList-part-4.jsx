...
class GroceryList extends React.Component {
  ...
  toggleGroceryCompleteness(groceryIndex) {
    let completeStatus = this.state.groceries[groceryIndex].completed;

    let item = Object.assign({}, this.state.groceries[groceryIndex]);
    ...
    item.completed = outgoingStatus;

    let oldGroceries = this.state.groceries;
    let newGroceries = [].concat(oldGroceries);
    newGroceries[groceryIndex] = item;

    this.setState({groceries : newGroceries}, function(){console.log(this.state)});
